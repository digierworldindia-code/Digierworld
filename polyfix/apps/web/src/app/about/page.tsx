...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildMetadata({
    seo: page?.seo ?? null,
    fallbackTitle: `About ${BRAND.name} — Mattress Manufacturer`,
    fallbackDescription:
      ...
      <section className="section-tight">
        <div className="container hero__grid">
          <div className="stack">
            ...
            <p className="lede">
              {hero.body ??
                `${BRAND.name} manufactures mattresses and sells them through appointed dealers. Every mattress is serialised at the end of the line, and that serial stays with it through dispatch, sale, warranty and any claim.`}
            </p>
          </div>

          <div className="hero__media">
            <Image
              src="/images/about/polyfix-factory.svg"
              alt={`${BRAND.shortName} production floor with mattress assembly in progress`}
              width={1600}
              height={1000}
              priority
