...
import { getPrisma, disconnectPrisma, withDbContext, type TransactionClient, type PrismaClient } from '@polyfix/database';
...
export default fp(prismaPlugin, { name: 'polyfix-prisma' });
