...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildMetadata({
    seo: page?.seo ?? null,
    fallbackTitle: 'COLIFEES Dealers — Find a Mattress Showroom Near You',
    fallbackDescription:
      ...
      <section className="section section-sand" id="apply">
        <div className="container hero__grid">
          <div className="stack">
            ...
            <h2>Become a COLIFEES dealer</h2>
            <p className="lede">
              If you run a furniture or bedding retail business and want to carry COLIFEES, send us
