...
export const metadata: Metadata = buildMetadata({
  ...
  fallbackDescription: 'How COLIFEES collects, uses and protects personal information.',
  path: '/privacy',
});
 ...
 * COLIFEES should have it reviewed by a lawyer before launch and update the
    ...
    <>
      ...
      <section className="section-tight">
        <div className="container-narrow stack-lg">
          ...
          <p className="muted">
            This policy describes what this website and the COLIFEES platform collect, why, and how
          ...
          <div className="stack">
            ...
            <p className="muted">
              When you buy a COLIFEES mattress, your dealer records the sale against the
