...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildMetadata({
    ...
    fallbackDescription:
      'Verify a COLIFEES mattress by QR code or serial number. See the product, manufacturing date and warranty status, and learn how to raise a warranty claim.',
    path: '/warranty',
  });
}
      ...
      <section className="section-tight">
        <div className="container hero__grid">
          <div className="stack">
            ...
            <h1>Verify your COLIFEES mattress</h1>
            <p className="lede">
          ...
          <div className="grid grid-2">
            ...
            <div className="card stack">
              ...
              <ul className="stack" style={{ paddingLeft: '1.1rem', color: 'var(--ink-muted)' }}>
                ...
                <li>Any mattress bought from someone other than an appointed COLIFEES dealer</li>
              </ul>
            </div>
          </div>
        </div>
