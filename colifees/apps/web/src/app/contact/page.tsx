...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildMetadata({
    seo: page?.seo ?? null,
    fallbackTitle: 'Contact COLIFEES — Mattress Enquiries & Support',
    fallbackDescription: 'Contact COLIFEES for product questions, dealership enquiries or warranty support.',
    path: '/contact',
  });
}
    ...
    <>
      ...
      <JsonLd
        schema={{
          ...
          '@type': 'ContactPage',
          name: 'Contact COLIFEES',
          url: 'https://colifees.com/contact',
        }}
      />
    </>
  );
