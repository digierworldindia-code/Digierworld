 ...
 * job of this page is to establish what COLIFEES makes, why it can be trusted,
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildMetadata({
    seo: page?.seo ?? null,
    fallbackTitle: 'COLIFEES — Premium Mattresses & Sleep Solutions',
    fallbackDescription:
      'COLIFEES manufactures premium hybrid, memory foam, latex and orthopaedic mattresses. Every unit carries a serial number you can verify online.',
    path: '/',
  });
}
...
const FALLBACK_HERO = {
  ...
  image: {
    src: '/images/hero/colifees-hero.svg',
    alt: 'A COLIFEES mattress in a calm, softly lit bedroom',
    width: 1600,
    height: 1100,
  },
};
    ...
    <>
      ...
      <section className="section section-sand reveal" aria-labelledby="why-heading">
        <div className="container">
          ...
          <p className="mt-7">
            <Link href="/why-colifees" className="btn btn-secondary">See what sits behind each of these</Link>
          </p>
        </div>
      </section>
      ...
      <section className="section section-ink reveal" aria-labelledby="craft-heading">
        <div className="container">
          <div className="section-head">
            ...
            <h2 id="craft-heading">{craftsmanship?.heading ?? 'How a COLIFEES mattress is made'}</h2>
            <p className="lede">
              {craftsmanship?.body ??
        ...
        <div className="container hero__grid">
          ...
          <div className="card" style={{ background: 'var(--sand)' }}>
            ...
            <div className="stack" style={{ marginTop: '1rem' }}>
              <span className="badge badge-positive">Genuine COLIFEES product</span>
      ...
      <section className="section section-sand reveal" aria-labelledby="dealers-heading">
        <div className="container">
          <div className="section-head">
            ...
            <h2 id="dealers-heading">{dealersSection?.heading ?? 'Find a COLIFEES dealer'}</h2>
            <p className="lede">
              {dealersSection?.body ??
