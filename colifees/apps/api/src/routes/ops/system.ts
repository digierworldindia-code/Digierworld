 ...
 * permission (see MFA_GATED_PERMISSIONS in @colifees/auth). Holding the role is
 * not enough: the current session must have completed a second factor.
 */
import type { FastifyInstance } from 'fastify';
import { z } from 'zod';
import { auditListQuery, readOnlySqlSchema, updateSettingSchema, pagination } from '@colifees/validation';
