 ...
 */
import type { TransactionClient } from '@colifees/database';
...
export async function verifyMattress(
  ...
  if (!warranty) {
    ...
    result.note =
      'This is a genuine COLIFEES product. Its warranty has not been activated yet — it starts when your dealer records the sale. If you have already bought it, ask your dealer to record the sale against this serial number.';
    return result;
  }
  ...
  result.note = {
    ACTIVE: `This is a genuine COLIFEES product and its warranty is active until ${result.warranty.endDate}.`,
    EXPIRED: `This is a genuine COLIFEES product. Its warranty period ended on ${result.warranty.endDate}.`,
    VOID: 'This is a genuine COLIFEES product, but the warranty on this unit is no longer valid. Contact your dealer for details.',
    SUPERSEDED:
      'This is a genuine COLIFEES product. This unit was replaced under warranty, and the cover now sits with the replacement mattress.',
    NOT_ACTIVATED: '',
  }[status];
