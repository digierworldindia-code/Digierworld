 ...
 * warranty term. No superlatives, no market-position claims. COLIFEES can edit
...
export const PRODUCTS: SeedProduct[] = [
  {
    ...
    website: {
      ...
      gallery: [
        { src: '/images/products/aurea-hybrid-1.svg', alt: 'COLIFEES Aurea Hybrid mattress shown on a wooden bed frame', width: 1200, height: 900 },
    ...
    seo: {
      title: 'Aurea Hybrid Mattress — Pocket Spring & Memory Foam | COLIFEES',
      description:
        'COLIFEES Aurea Hybrid combines pocketed springs with a memory foam comfort layer for medium-firm support and motion isolation. 10 year warranty. Five sizes.',
  ...
  },
  {
    ...
    name: 'COLIFEES Serenity Memory Foam',
    skuPrefix: 'SER',
    ...
    website: {
      ...
      gallery: [
        { src: '/images/products/serenity-1.svg', alt: 'COLIFEES Serenity Memory Foam mattress in a bedroom setting', width: 1200, height: 900 },
        { src: '/images/products/serenity-2.svg', alt: 'Layer diagram of the Serenity memory foam and support core', width: 1200, height: 900 },
      ],
    },
    seo: {
      title: 'Serenity Memory Foam Mattress — Pressure Relief | COLIFEES',
      description:
        'COLIFEES Serenity layers open-cell memory foam over a high-resilience core for medium-soft pressure relief. Removable washable cover. 10 year warranty.',
  ...
  },
  {
    ...
    name: 'COLIFEES Orthocore Support',
    skuPrefix: 'ORT',
    ...
    website: {
      ...
      gallery: [
        { src: '/images/products/orthocore-1.svg', alt: 'COLIFEES Orthocore Support firm mattress', width: 1200, height: 900 },
      ],
    },
    seo: {
      title: 'Orthocore Support Mattress — Firm High-Density Foam | COLIFEES',
      description:
        'COLIFEES Orthocore is a firm high-density foam mattress with a level sleeping surface and minimal sink. 8 year warranty. Five sizes.',
    ...
    faqs: [
      {
        ...
        answer:
          'It depends on the person and the cause. Firmer surfaces suit many back sleepers, while side sleepers often need more give at the shoulder. Speak to your doctor about your own situation, and try the mattress at a COLIFEES dealer before deciding.',
      },
    ],
  },
  {
    slug: 'latex-natura',
    name: 'COLIFEES Latex Natura',
    skuPrefix: 'LTX',
    category: 'Latex',
    ...
    website: {
      ...
      highlights: [
        ...
        { title: '12 year warranty', body: 'The longest term COLIFEES offers.' },
      ],
      gallery: [
        { src: '/images/products/latex-natura-1.svg', alt: 'COLIFEES Latex Natura mattress with natural latex comfort layer', width: 1200, height: 900 },
      ],
    },
    seo: {
      title: 'Latex Natura Mattress — Natural Latex Comfort | COLIFEES',
      description:
        'COLIFEES Latex Natura pairs a natural pin-core latex comfort layer with a high-resilience core. Breathable, responsive, 12 year warranty.',
  ...
  },
  {
    ...
    website: {
      ...
      gallery: [
        { src: '/images/products/dual-comfort-1.svg', alt: 'COLIFEES Dual Comfort flippable mattress showing both faces', width: 1200, height: 900 },
      ],
    },
    seo: {
      title: 'Dual Comfort Flippable Mattress — Firm and Soft | COLIFEES',
      description:
        'COLIFEES Dual Comfort has a firm face and a medium-soft face on one mattress. Flip to change firmness. 7 year warranty. Five sizes.',
